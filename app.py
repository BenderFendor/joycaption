...
# You have to run this inside of the folder for it to load the Stuff right I think nvm
...
if not os.path.exists(CHECKPOINT_PATH / "image_adapter.pt"):
    raise FileNotFoundError(f"Checkpoint file not found: {CHECKPOINT_PATH / 'image_adapter.pt'}")
